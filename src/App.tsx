...
function App() {
  ...
  return (
    <div className={`flex flex-col min-h-screen md:h-full md:h-[100dvh] md:max-h-[100dvh] w-full md:overflow-hidden transition-colors duration-300 ${darkMode ? "bg-[#0E1117] text-slate-100" : "bg-[#EAECEF] text-[#101828]"}`}>
      {/* ── Header ── */}
      <TopNavBar
        darkMode={darkMode}
      ...
      {/* ── Main body layout ── */}
      <div className="flex flex-col md:flex-row flex-1 md:overflow-hidden relative w-full">
